  ...
  <div class="home">
    ...
    <div class="recent-matches card">
      ...
      <div v-else class="matches-list">
        <div v-for="match in matches" :key="match.match_id" class="match-item" style="background: rgba(255,255,255,0.7); padding: 15px; border-radius: 10px; margin-bottom: 10px;">
          ...
          <div style="margin-top: 15px; display: flex; gap: 10px;">
            <router-link :to="`/mc/${match.match_id}`" class="btn btn-small">
              <i class="fas fa-edit"></i> Gérer (MC)
            </router-link>
            <router-link :to="`/sound/${match.match_id}`" class="btn btn-small btn-secondary">
